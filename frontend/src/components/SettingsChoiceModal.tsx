      ...
      <View style={styles.modalRoot}>
        ...
        <View style={styles.card}>
          <View style={styles.headerRow}>
            <View style={styles.headerIcon}><Ionicons name="sparkles-outline" size={19} color={colors.paper} /></View>
...
const makeStyles = (colors: ReturnType<typeof useTheme>['colors']) => StyleSheet.create({
  ...
  card: { width: '100%', maxWidth: 420, backgroundColor: colors.paper, borderRadius: 26, padding: 22, borderWidth: 1, borderColor: colors.border, shadowColor: '#000', shadowOpacity: 0.18, shadowRadius: 24, shadowOffset: { width: 0, height: 12 }, elevation: 10 },
