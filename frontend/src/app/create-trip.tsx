...
const makeStyles = (colors: ReturnType<typeof useTheme>['colors']) => StyleSheet.create({
  ...
  featureList: { backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, paddingHorizontal: 17, marginBottom: 24 }, featureItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 15, borderBottomWidth: 1, borderBottomColor: colors.divider }, featureIcon: { width: 40, height: 40, borderRadius: 14, backgroundColor: '#FCE5DD', alignItems: 'center', justifyContent: 'center', marginRight: 13 }, featureCopy: { flex: 1 }, featureTitle: { color: colors.textPrimary, fontSize: 15, fontWeight: '800', marginBottom: 3 }, featureDesc: { color: colors.textSecondary, fontSize: 12, lineHeight: 17 }, submitBtn: { marginTop: 3 },
});
